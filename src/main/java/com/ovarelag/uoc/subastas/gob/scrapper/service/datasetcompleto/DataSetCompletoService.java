...
public class DataSetCompletoService implements IDataSetCompletoService {
	...
	static Logger logger = LoggerFactory.getLogger(DataSetCompletoService.class);
	...
	private static SubastaMiniatura procesarMiniatura(int id, Element enlace, Elements miniatura) {
		String absoluteURLPath = URL_BASE + enlace.attr("href").toString();
		logger.info("Enlace url subasta completa: " + absoluteURLPath);
		...
		while (miniaturaIt.hasNext()) {
			...
			toReturnElemento = new SubastaMiniatura(id, titulo, juzgado, expediente, estado, descripcion, absoluteURLPath);
	...
	public List<SubastaMiniatura> crearListaMiniaturas(String urlBase, StringBuilder nextScrapURL, int indiceInicial)
		...
		//String html = scrapperTools.getUrl(urlBase, null);
	...
	@Override
	public void almacenarDataSetFormatoCSV(List<SubastaRow> listaSubastas)
	...
	@Override
	public void almacenarDataSetFormatoCSV(List<?> listaMiniaturas, Integer contadorUrlProcesadas)
